...
// console.log('Util.isNumber(\"  \"))', Util.isNumber("   "));
// console.log('Util.isNumber(\"\"))', Util.isNumber(""));
...
// console.log("Util.formatNumber(1000000.3232)",Util.formatNumber(1000000.3232));
// console.log("Util.formatNumber(0.3232)",Util.formatNumber(0.3232));
...
// console.log("Util.isPlalindromeString('A man, a plan, a canal: Panama')",Util. isPlalindromeString('A man, a plan, a canal: Panama'));
// console.log("Util.isPlalindromeString('A man, a plan, a canal: Panam')",Util. isPlalindromeString('A man, a plan, a canal: Panam'));
